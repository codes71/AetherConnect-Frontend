      ...
      <main className="flex-1">
        <section className="container mx-auto flex flex-col items-center px-4 py-20 text-center md:py-32">
          ...
          <p className="mt-6 max-w-2xl text-lg text-muted-foreground">
            AetherConnect is a real-time chat application built with a
            microservices architecture to demonstrate advanced system design,
          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-4 text-muted-foreground">
                Explore the production-ready features that make AetherConnect a
        ...
        <section className="container mx-auto px-4 py-20 md:py-32">
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-muted-foreground">
                Leveraging NestJS for scalable backend services, gRPC for
                efficient communication, and Kafka for event-driven
                architecture, AetherConnect is built for performance.
              </p>
